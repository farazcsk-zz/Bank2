...
public class CreateIRAAccount extends AppCompatActivity {
    ...
    public void cIRAAccount(View view) {
        ...
        List<String> createIraAccountList = new ArrayList<>();
        createIraAccountList = ctrl.createAccount(6, name, id, "");

        ListAdapter cIraAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, createIraAccountList);
        ListView createIraAccountListView = (ListView) findViewById(R.id.iraAccount_listview);

        createIraAccountListView.setAdapter(cIraAdapter);
